...
@XmlRegistry	//root tag for child elements
public class Person {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)//if not given it take default strategy(auto--where id number continue inspire of tables)
	int id;
	String name;
