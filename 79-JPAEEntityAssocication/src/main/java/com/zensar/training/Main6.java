...
/*
 * 3 tables will be created join table--which will subject id and course id
 * subject table will have the subject elements
 * Course will have all the course element
 * one to many because we have one course which have collection of subject
 * */