...
public class Main2 {
	...
	private static void editTesting() {
		...
		course.getSubjects().add(new Subject(" React JS", 24));//add extra row
...
/*
 * Subject table will have collection of courses with 2 id course id and subject id
 * subject id will be different but course id will be same for all
 * Course table will have only 1 row where as subject will have 5 row 
 * 
 * */
