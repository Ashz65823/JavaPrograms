...
public class Course {
	...
	@JoinColumn(name = "Cource_id", nullable = false)//no null value will be given--forging key to not be nulln
	Set<Subject> subjects;//set will contain multiple subject option
