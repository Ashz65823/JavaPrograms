...
public class Person {
	...
	@OneToOne(mappedBy = "person",cascade = CascadeType.ALL)//mapped by person is the person object from contact-info
	@PrimaryKeyJoinColumn
	ContactInfo contactInfo;//entity association--person key is stored with contactinfo
