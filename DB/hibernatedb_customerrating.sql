...
LOCK TABLES `customerrating` WRITE;
/*!40000 ALTER TABLE `customerrating` DISABLE KEYS */;
INSERT INTO `customerrating` VALUES (1,'Sridhar');
/*!40000 ALTER TABLE `customerrating` ENABLE KEYS */;
UNLOCK TABLES;
